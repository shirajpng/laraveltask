...
@section('content')
    <div style="margin-bottom: 20px">
        <a href="/" style="text-decoration: none;"><i class="fa fa-arrow-left"></i>  Back</a>
    </div>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        {!! Form::textarea('education', null, ['class' => 'form-control', 'placeholder' => 'enter education background...']) !!}
                    </div>
                </div>
            </div>
        </div>
